...
if st.session_state.analisis_completado:
    ...
    if gdf_completo is not None:
        ...
        # ... (el resto del código de las pestañas es idéntico al original, no se modifica)
        # Por brevedad, no repito todo el contenido de las pestañas, pero en el archivo final deben estar completas.
        # Aquí se asume que se mantiene el mismo código de pestañas que en el archivo original.
